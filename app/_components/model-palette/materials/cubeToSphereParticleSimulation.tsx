import simulationVertexShader from '@/app/_components/model-palette/materials/shaders/cubeToSphereSimulation.vert'
import simulationFragmentShader from '@/app/_components/model-palette/materials/shaders/cubeToSphereSimulation.frag'
