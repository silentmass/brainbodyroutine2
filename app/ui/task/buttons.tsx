...
export function SetTaskActive({ task, handleResponseMessage, setResponseState }: {
    task: Task, handleResponseMessage: (state: boolean) => void, setResponseState: (state: any) => void
}) {
    ...
    const mouseActiveStyle = isMouseActiveCheck ? "check-active" : "check-nonactive";
            ...
            <div className="relative">
                ...
                {(isActive === true)
                    ? (
                        <svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_102_1221)">
                                <circle cx="14" cy="14" r="11.5" fill="#F3F4F6" stroke="#374151" className={`unchecked ${mouseOverStyle} ${mouseActiveStyle}`} />
                                <g clipPath="url(#clip1_102_1221)">
                                    {/* Reflection */}
                                    <path opacity="0.1" d="M23 30.5C23 29.5631 22.1801 28.5641 20.5035 27.7699C18.8649 26.9937 16.5662 26.5 14 26.5C11.4338 26.5 9.13506 26.9937 7.49653 27.7699C5.81986 28.5641 5 29.5631 5 30.5C5 31.4369 5.81986 32.4359 7.49653 33.2301C9.13506 34.0063 11.4338 34.5 14 34.5C16.5662 34.5 18.8649 34.0063 20.5035 33.2301C22.1801 32.4359 23 31.4369 23 30.5Z" fill="#F3F4F6" stroke="#374151" className={`unchecked ${mouseOverStyle} ${mouseActiveStyle}`} />
                                    <g opacity="0.1" filter="url(#filter0_d_102_1221)">
                                        <path d="M24 36C12.9276 33.1564 16.7083 24.4554 10 32.0115" stroke="#374151" strokeWidth="2" className={`mark unchecked ${mouseOverStyle} ${mouseActiveStyle}`} />
                                    </g>
                                    <rect width="28" height="12" transform="translate(0 26)" fill="url(#paint0_linear_102_1221)" />
                                </g>
                                <g filter="url(#filter1_d_102_1221)">
                                    <path d="M27 1C12.764 7.90595 17.625 29.0368 9 10.6864" stroke="#374151" strokeWidth="2" className={`mark unchecked ${mouseOverStyle} ${mouseActiveStyle}`} />
                                </g>
                            </g>
                            <defs>
                                <filter id="filter0_d_102_1221" x="6.2522" y="25.9999" width="20.9966" height="14.9686" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    : (
                        <svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_102_1221)">
                                <circle cx="14" cy="14" r="11.5" fill="#F3F4F6" stroke="#374151" className={`checked ${mouseOverStyle} ${mouseActiveStyle}`} />
                                <g clipPath="url(#clip1_102_1221)">
                                    <path opacity="0.1" d="M23 30.5C23 29.5631 22.1801 28.5641 20.5035 27.7699C18.8649 26.9937 16.5662 26.5 14 26.5C11.4338 26.5 9.13506 26.9937 7.49653 27.7699C5.81986 28.5641 5 29.5631 5 30.5C5 31.4369 5.81986 32.4359 7.49653 33.2301C9.13506 34.0063 11.4338 34.5 14 34.5C16.5662 34.5 18.8649 34.0063 20.5035 33.2301C22.1801 32.4359 23 31.4369 23 30.5Z" fill="#F3F4F6" stroke="#374151" className={`checked ${mouseOverStyle} ${mouseActiveStyle}`} />
                                    <g opacity="0.1" filter="url(#filter0_d_102_1221)">
                                        <path d="M24 36C12.9276 33.1564 16.7083 24.4554 10 32.0115" stroke="#374151" strokeWidth="2" />
                                    </g>
                                    <rect width="28" height="12" transform="translate(0 26)" fill="url(#paint0_linear_102_1221)" />
                                </g>
                                <g filter="url(#filter1_d_102_1221)">
                                    <path d="M27 1C12.764 7.90595 17.625 29.0368 9 10.6864" stroke="#374151" strokeWidth="2" />
                                </g>
                            </g>
                            <defs>
                                <filter id="filter0_d_102_1221" x="6.2522" y="25.9999" width="20.9966" height="14.9686" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                ...
                <button
                    ...
                    onMouseLeave={() => { setIsMouseOverCheck(false); setIsMouseActiveCheck(false); }}
